        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-9 col-sm-12 px-0 login-section">
                    <p class="text-center lead pt-3"><strong>Schedule Pickup</strong></p>
                    <hr class="text-dark py-1">
                    <form action="../controllers/SchedulerTwo.php" method="post">
                        <div class="row px-3">
                            <div class="col-lg-6 col-sm-12 pt-1 text-center">Date:<input required name="orderdate" type="date" placeholder=0 min="0" class="form-control text-center mt-2" id="exampleInputEmail1" aria-describedby="emailHelp"></div>
                            <div class="col-lg-6 col-sm-12 pt-1 text-center">
                                <!-- Time: -->
                                <label for="disabledSelect" class="form-label">Time</label>
                                <select id="hour-option" name="working-hours" class="form-select">
                                    <!-- <option>Disabled select</option> -->
                                </select>
                                <!-- <input required name="ordertime" type="time" placeholder=0 min="0" class="form-control text-center" id="exampleInputEmail1" aria-describedby="emailHelp"> -->
                            </div>
