            ...
            <div class="row">
                <div class="col-lg-3 col-sm-12 px-1 login-section ">
                    <div class="list-group list-group-flusht">
                        <a class="list-group-item list-group-item-action text-dark lead mt-2 mx-2" href="dashboard.php">Pickups</a>
                        <a class="list-group-item list-group-item-action text-primary lead mt-2 mx-2" href="vendorcollection.php">Deliveries</a>
