...
class Order{
    ...
    public function createOrder(){
        $query="INSERT INTO Orders(C_ID, pickup_status,Bluebag_Count, Greenbag_Count, serviced_vendor, spl_instructions, pickup_date, pickup_time, delivery_status, order_status) VALUES 
        (:C_id,:pickup_status,:bluebag,:greenbag,:serviced_vendor,:spl_instructions,:pickup_date,:pickup_time,:delivery_status,:order_status)";
    ...
    public function pendingCollection(){
        $query = "SELECT * FROM Orders WHERE Delivery_Status ='Pending Collection'";
        $statement = $this->conn->prepare($query);
    ...
    public function vendorPickup(){
        $query = "SELECT * FROM Orders WHERE Order_Status ='Ready'";
        $statement = $this->conn->prepare($query);
