<?php
    ...
    $order = new Order($db);
    $result = $order->pendingCollection();
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0 justify-content-right">
                    ...
                    <li class="nav-item ms-2 d-none d-lg-block">
                        ...
                        <p class="nav-link py-0"><?php echo "Welcome Driver with " . $_SESSION['zip-code'];?></p>
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-12 px-1 login-section ">
                    <div class="list-group list-group-flusht">
                        <a class="list-group-item list-group-item-action text-primary lead mt-2 mx-2" href="dashboard.php">Customer to vendor</a>
                        <a class="list-group-item list-group-item-action text-dark lead mt-2 mx-2" href="vendorcollection.php">Vendor to customer </a>
                        <a class="list-group-item list-group-item-action text-dark lead mt-2 mx-2" href="updateprofile.php">Vendor to customer </a>

                    </div>
                </div>
                <div class="col-lg-9 col-sm-12 px-3 login-section">
                    <h4 class="py-4 ps-3">Pickup from Customer</h4>
                        ...
                        <tbody>
                            ...
                            <?php foreach($result as $result) :?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $result['PickUp_Time']?></td>
                                    <td>
                                        <form action="../controllers/DriverPickupController.php" method="post">
                                            <input name="order" id="" type="hidden" value="<?php echo $result['Order_ID']?>">
                                            <button class="btn btn-primary" type="submit">SELECT FOR PICKUP</button>
                                        </form>
                                    </td>
                                </tr>
                            <?php endforeach ?>
