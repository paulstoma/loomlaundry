<?php
    ...
    $user = new User($db);
    $results=$user->selectDriver($_SESSION['id']);
    // var_dump($results);
?>
...
<head>
    ...
    <title>Laundry Loom - Update profile</title>
                        ...
                        <div class="row bg-white">
                            ...
                            <div class="col-lg-6 col-sm-12">
                                ...
                                <div class="row px-3">
                                    ...
                                    <div class="col-lg-8 col-sm-12">
                                        <input name="zipcode" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $results['D_ZipCode']?>">
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6 col-sm-12 p-3 pt-5">
                                ...
                                <div class="row py-1">
                                    ...
                                    <div class="col-lg-8 col-sm-12">
                                        <input required name="email" type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $results['D_Address']?>">
                                    </div>
                                </div>
                                <div class="row py-1">
                                    <div class="col-lg-4 col-sm-12">
                                    ...
                                    <div class="col-lg-8 col-sm-12">
                                        <input required name="phonenumber" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $results['D_PhoneNumber']?>">
                                    </div>
                                </div>
                                <!-- <div class="row py-1"> -->
                                    <!-- <div class="col-lg-4 col-sm-12">
