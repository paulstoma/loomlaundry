                        ...
                        <div class="row">
                            <div class="col-lg-6 col-sm-12">
                                <div class="row px-3">
                                    ...
                                    <div class="col-lg-6 col-sm-12"><input id="bluebag" required name="professionalblue" type="number" min="0" class="form-control"></div>
                                </div>
                                <div class="row pt-5 px-3">
                                    <div class="col-lg-6 col-sm-12 pt-1">Professional (Green bag):</div>
                                    <div class="col-lg-6 col-sm-12"><input id="greenbag" required name="professionalgreen" type="number" min="0" class="form-control"></div>
                                </div>
                                <!-- <div class="row pt-5 px-3">
                                    <div class="col-lg-6 col-sm-12 pt-1">Special (# of items):</div>
                                    <div class="col-lg-6 col-sm-12"><input id="specialbag" required name="specialorder" type="number" min="0" class="form-control"></div>
                                </div> -->
