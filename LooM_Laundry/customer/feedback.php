            ...
            <div class="row">
                <div class="col-lg-3 col-sm-12 px-1 login-section ">
                    ...
                    <a class="list-group-item list-group-item-action text-dark lead mt-2 mx-2" href="dashboard.php">LooM Dashboard</a>
                        ...
                        <a class="list-group-item list-group-item-action text-primary lead mt-2 mx-2" href="feedback.php">Feedback</a>
                    </div>
                </div>
                <div class="col-lg-9 col-sm-12 px-0 login-section">
                    <h1 class="text-center p-2">Feedback</h1>
                    <p class="lead text-center px-5 pt-4"><strong>We would love to hear your thoughts, suggestions, concerns, 
                        or problems with anything so that we can improve</strong></p>
                    <!-- <hr> -->
                    <!-- <h4 class="text-center">Feedback Type</h4> -->
                    <!-- <div class="form-check px-4 text-center">
                        <label class="px-5">
                            <input type="radio" name="feedbacktype" checked value="comments">Comments
                        </label>
                        <label class="px-5">
                            <input type="radio" name="feedbacktype" value="suggestion">Suggestions
                        </label>
                        <label class="px-5">
                    ...
                    <div class="row text-center px-4">
                        <div class="col-lg-12">
                            <div class="star-rating">
                                ...
                                <input type="hidden" name="star-rating" class="rating-value" value="0">
                            </div>
                        </div>
                    </div>
                    <div class="feedback p-4">
                        <p>Enter your feedback:</p>
                        <textarea required name="feedbackdescription" id="" rows="3" class="form-control"></textarea>
