<?php
    ...
    $user = new User($db);
    $results=$user->selectVendor($_SESSION['id']);
    // var_dump($results);
?>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-9 col-sm-12 px-0 login-section px-4">
                    ...
                    <div class="container ">
                        <form action="../controllers/VendorProfileController.php" method="post">
                            ...
                            <div class="col-lg-12 col-sm-12 p-3">
                                <div class="row py-1">
                                    ...
                                    <div class="col-lg-8 col-sm-12">
                                        <input required name="fname" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $results['V_Name']?>">
                                    </div>
                                </div>
                                <!-- <div class="row py-1">
                                    <div class="col-lg-4 col-sm-12">
                                    ...
                                    <div class="col-lg-8 col-sm-12">
                                        <input required name="lname" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $results['C_LastName']?>">
                                    </div>
                                </div> -->
                                <div class="row py-1">
                                    <div class="col-lg-4 col-sm-12">
                                    ...
                                    <div class="col-lg-8 col-sm-12">
                                        <input required name="email" type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $results['V_Address']?>">
                                    </div>
                                </div>
                                <div class="row py-1">
                                    <div class="col-lg-4 col-sm-12">
                                    ...
                                    <div class="col-lg-8 col-sm-12">
                                        <input required name="phonenumber" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $results['V_PhoneNumber']?>">
                                    </div>
                                </div>
                                <!-- <div class="row py-1">
                                    <div class="col-lg-4 col-sm-12">
                                ...
                                <div class="row py-1">
                                    ...
                                    <div class="col-lg-8 col-sm-12">
                                        <input required name="previouspassword" type="password" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                    </div>
                                </div>
                                <div class="row py-1">
                                    <div class="col-lg-4 col-sm-12">
                                    ...
                                    <div class="col-lg-8 col-sm-12">
                                        <input required name="newpassword" type="password" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                    </div>
                                </div>
                                <div class="row py-1">
                                    <div class="col-lg-4 col-sm-12">
                                    ...
                                    <div class="col-lg-8 col-sm-12">
                                        <input required name="confirmnewpassword" type="password" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="d-grid gap-2">
                            <button class="btn btn-primary my-3" type="submit">Update Profile</button>
                        </div>
                        </form>
                    </div>
