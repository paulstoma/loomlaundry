            ...
            <div class="row">
                <div class="col-lg-3 col-sm-12 px-1 login-section ">
                    ...
                    <div class="list-group list-group-flusht">
                        ...
                        <a class="list-group-item list-group-item-action text-primary lead mt-2 mx-2" href="orderstatus.php">Order Status</a>
                        <a class="list-group-item list-group-item-action text-dark lead mt-2 mx-2" href="ready.php">Ready for Pickup</a>
                        <a class="list-group-item list-group-item-action text-dark lead mt-2 mb-3 mx-2" href="updateprofile.php">Update Profile</a>

                    </div>
                </div>
                <div class="col-lg-9 col-sm-12 px-3 login-section">
                    <h4 class="p-4">Received Order Status</h4>
                    ...
                    <table class="table table-striped ps-3">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <?php if ($result["Order_Status"] != "Pending Collection" && $result["Order_Status"] != "In Transit") :?>
