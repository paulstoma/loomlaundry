    ...
    <div class="intro-section">
        <div class="container login-section">
            <div class="row px-md-5">
                <div class="col-md-4 col-sm-12 px-4 py-5">
                    
                    <div class="centered text-centered py-2">
                    <h4 class="text-center bg-light text-dark m-0 py-2">Prasanna Kileti</h4>
                        <img src="resources/images/profile-pic.png" class=" pb-5 img-thumbnail img-fluid px-5" id="center-image" alt="shirt image">
                    </div>
                </div>
                <div class="col-md-4 col-sm-12 px-4 py-5">
                
                    <div class="centered text-centered py-2">
                    <h4 class="text-center bg-light text-dark m-0 py-2">Pauls Toma</h4>
                        <img src="resources/images/profile-pic.png" class=" pb-5 img-thumbnail img-fluid px-5" id="center-image" alt="shirt image">
                    </div>
                </div>
                <div class="col-md-4 col-sm-12 px-4 py-5">
                    ...
                    <div class="centered text-centered py-2">
                    <h4 class="text-center bg-light text-dark m-0 py-2">Suvarna Joshi</h4>
                        <img src="resources/images/profile-pic.png" class=" pb-5 img-thumbnail img-fluid px-5" id="center-image" alt="shirt image">
                    </div>
                </div>
            </div>
