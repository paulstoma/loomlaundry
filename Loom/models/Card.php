...
class Card{
    ...
    public function saveCard(){
        $query = "INSERT INTO CreditCards (CardNumber, CardName, CardType,CardCVC, CardValid, C_ID) 
        VALUES (:cardno,:cardname, :cardtype, :cardcvc, :cardvalid, :customer)";
        ...
        $statement->bindValue(":cardvalid",$this->cardvalid);
